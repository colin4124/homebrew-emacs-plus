...
class EmacsPlusAT28 < EmacsBase
  ...
  option "with-no-titlebar-alt", "Experimental: build without titlebar (rounded corners)"
  ...
  local_patch "no-titlebar-alt", sha: "c536a033104ffcd9894d3819324f771ee22710f4f739cb2b70e2a01de9dc29af" if build.with? "no-titlebar-alt"
